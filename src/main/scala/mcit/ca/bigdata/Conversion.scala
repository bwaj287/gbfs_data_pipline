...
//  val systemIewesnformation: String = "/Users/vasusurani/Downloads/Final Project Big Data/data2/system_information.json"
//
...
//    .save("/Users/vasusurani/Downloads/Final Project Big Data/enrichedStationData")
  ...
  stmt.execute("DROP TABLE IF EXISTS winter2020_vasu.ext_station_information")
  val stationInformationTable = new StationInformationTable().stationInformationTable
  stmt.execute(stationInformationTable)

  stmt.execute("DROP TABLE IF EXISTS winter2020_vasu.ext_system_information")
  val systemInformationTable = new SystemInformationTable().systemInformationTable
  stmt.execute(systemInformationTable)
